                                  ...
                                  unsigned int *pto)
{
	...
	/* TODO implement the following paragraph for QUIC on backend side.
	 * Note that if now_ms is used this function is not reentrant anymore
	 * and can not be used anytime without side-effect (for example after
