...
struct mux_ops {
	...
	int (*iuqcs_subscribe)(struct iuqcs *qcs, int event_type,  struct wait_event *es); /* Subscribe <es> to events, "being able to receive" only */
	int (*iuqcs_unsubscribe)(struct iuqcs *qcs, int event_type,  struct wait_event *es); /* Unsubscribe <es> from events */
	int (*ouqcs_subscribe)(struct ouqcs *qcs, int event_type,  struct wait_event *es); /* Subscribe <es> to events, "being able to send" only */
	int (*ouqcs_unsubscribe)(struct ouqcs *qcs, int event_type,  struct wait_event *es); /* Unsubscribe <es> from events */
